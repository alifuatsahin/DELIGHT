...
class VAE(nn.Module):
    def __init__(self, cfg, mode='training'):
        ...
        self.decoder = Decoder(cfg.model, mode=mode)
    ...
    def decode(self, p, g, sampled_cloud_size, labeled_samples=False, warmup=False):
        output = self.decoder(p, g, sampled_cloud_size, warmup=warmup, labeled_samples=labeled_samples)
    ...
    def forward(self, p, g, n_sampled_points=None, labeled_samples=False, warmup=False):
        ...
        print(f"Shape of the latent vector: {g_sample.shape}")
