...
from utils.eval_metrics import distChamferCUDA
...
class MaskTransformer(nn.Module):
    def __init__(self, config, **kwargs):
        ...
        logger.info(f'[args] {config.transformer_config}', logger = 'Transformer')
        # embedding
...
class PCP_MAE(nn.Module):
    def __init__(self, config):
        ...
        logger.info(f'[PCP_MAE] divide point cloud into G{self.num_group} x S{self.group_size} points ...', logger ='PCP_MAE')
